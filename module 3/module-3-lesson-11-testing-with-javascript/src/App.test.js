...
En el ejercicio 1 hemos visto que el test comprueba si hay una etiqueta HTML que tiene el texto Aprendiendo React.
Ahora vamos a testear de qué tipo es esa etiqueta HTML, si es un link, un párrafo, una cabecera...
*/